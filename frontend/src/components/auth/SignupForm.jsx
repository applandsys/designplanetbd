            ...
            <div className="w-full max-w-md bg-white p-8 rounded shadow">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="bg-[#a1a1cb] text-[#484899] font-bold px-4 py-2 rounded">{randomNumber}</div>
                    </div>
                    ...
                    <div className="flex items-center mt-4 space-x-2 text-sm">
                        ...
                        <label>
                            ...
                            <a href="#" className="text-[#484899]  hover:underline">Learn more</a>
                        </label>
                    </div>

                    <button
                        type="submit"
                        className="w-full bg-[#484899] hover:bg-[#a1a1cb] text-white font-semibold py-2 rounded mt-4"
                    >
                        Submit & Register
                    </button>
